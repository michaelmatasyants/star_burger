...
Если получаем `Killed`, скорее всего причина в недостаточном количестве памяти.
Чтобы решить проблему изменим конфигурацию `swap`:
```sh
...
[A link](https://github.com/devmanorg/star-burger-products) that can be used to retrieve data for the site.

## Project Objectives

The code is written for educational purposes. The project code was taken as a basis from [FoodCart](https://github.com/Saibharath79/FoodCart).
